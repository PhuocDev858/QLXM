...
<div class="container py-4">
    <h1 class="fw-bold text-center mb-4" style="color:#fff;">Thêm khách hàng mới</h1>
        ...
        <div class="card-body p-4">
            <form id="customerForm" action="{{ route('admin.customers.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="phone" name="phone" class="form-control" value="{{ old('phone') }}" pattern="[0-9]{10,11}" title="Số điện thoại phải có 10-11 chữ số" required>
                </div>
                <div class="mb-3">
